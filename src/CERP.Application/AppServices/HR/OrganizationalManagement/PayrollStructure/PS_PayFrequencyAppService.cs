...
{
    public class PS_PayFrequencyAppService : CrudAppService<PS_PayFrequency, PS_PayFrequency_Dto, int, PagedAndSortedResultRequestDto, PS_PayFrequency, PS_PayFrequency_Dto>
    {
