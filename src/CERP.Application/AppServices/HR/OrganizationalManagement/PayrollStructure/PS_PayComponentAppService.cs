...
{
    public class PS_PayComponentAppService : CrudAppService<PS_PayComponent, PS_PayComponent_Dto, int, PagedAndSortedResultRequestDto, PS_PayComponent, PS_PayComponent_Dto>
    {
