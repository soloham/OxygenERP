...
namespace CERP.Data
{
    public class CERPDbMigrationService : ITransientDependency
    {
        public ILogger<CERPDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly ICERPDbSchemaMigrator _dbSchemaMigrator;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public CERPDbMigrationService(
            IDataSeeder dataSeeder,
            ICERPDbSchemaMigrator dbSchemaMigrator,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<CERPDbMigrationService>.Instance;
        }
