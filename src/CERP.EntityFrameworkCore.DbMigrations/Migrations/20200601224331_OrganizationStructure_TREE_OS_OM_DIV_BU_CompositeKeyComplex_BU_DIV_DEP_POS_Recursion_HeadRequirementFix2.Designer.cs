...
namespace CERP.Migrations
{
    ...
    [Migration("20200601224331_OrganizationStructure_TREE_OS_OM_DIV_BU_CompositeKeyComplex_BU_DIV_DEP_POS_Recursion_HeadRequirementFix2")]
    partial class OrganizationStructure_TREE_OS_OM_DIV_BU_CompositeKeyComplex_BU_DIV_DEP_POS_Recursion_HeadRequirementFix2
    {
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartmentCostCenter", b =>
                {
                    ...
                    b.HasIndex("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DivisionTemplateId", "DepartmentTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", b =>
                {
                    ...
                    b.HasKey("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DivisionTemplateId", "DepartmentTemplateId", "HeadPositionTemplateId", "PositionTemplateId");
                    ...
                    b.HasIndex("OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OrganizationStructureTemplateDepartmentBusinessUnitTemplateId", "OrganizationStructureTemplateDepartmentDivisionTemplateId", "OrganizationStructureTemplateDepartmentDepartmentTemplateId");

                    b.HasIndex("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DivisionTemplateId", "DepartmentTemplateId", "PositionTemplateId", "HeadPositionTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePositionJob", b =>
                {
                    ...
                    b.HasIndex("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DivisionTemplateId", "DepartmentTemplateId", "HeadPositionTemplateId", "PositionTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", "OrganizationStructureTemplateDepartment")
                        .WithMany()
                        .HasForeignKey("OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OrganizationStructureTemplateDepartmentBusinessUnitTemplateId", "OrganizationStructureTemplateDepartmentDivisionTemplateId", "OrganizationStructureTemplateDepartmentDepartmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", "OrganizationStructureTemplateHeadPosition")
                        .WithMany("OrganizationStructureTemplatePositions")
                        .HasForeignKey("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DivisionTemplateId", "DepartmentTemplateId", "PositionTemplateId", "HeadPositionTemplateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePositionJob", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", "OrganizationStructureTemplatePosition")
                        ...
                        .HasForeignKey("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DivisionTemplateId", "DepartmentTemplateId", "HeadPositionTemplateId", "PositionTemplateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
