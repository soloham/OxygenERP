...
namespace CERP.Migrations
{
    ...
    [Migration("20200313165126_UpdatedTimesheetAndRemovedMonthlyTimesheets")]
    partial class UpdatedTimesheetAndRemovedMonthlyTimesheets
    {
            ...
            modelBuilder.Entity("CERP.HR.Timesheets.TimesheetWeekSummary", b =>
                {
                    b.HasOne("CERP.HR.Employees.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("CERP.HR.Timesheets.TimesheetWeekSummary", "EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
