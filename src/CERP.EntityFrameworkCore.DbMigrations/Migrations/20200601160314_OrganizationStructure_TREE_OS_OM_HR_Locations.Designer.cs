...
namespace CERP.Migrations
{
    ...
    [Migration("20200601160314_OrganizationStructure_TREE_OS_OM_HR_Locations")]
    partial class OrganizationStructure_TREE_OS_OM_HR_Locations
    {
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateBusinessUnit", b =>
                {
                    ...
                    b.Property<int>("HeadOrganizationStructureTemplateBusinessUnitId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HeadOrganizationStructureTemplateBusinessUnitId", "HeadPositionTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", b =>
                {
                    ...
                    b.Property<int>("HeadOrganizationStructureTemplateDepartmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HeadOrganizationStructureTemplateDepartmentId", "HeadPositionTemplateId");

                    b.HasIndex("ParentBUOrganizationStructureTemplateId", "ParentBUBusinessUnitTemplateId");

                    b.HasIndex("ParentDEPOrganizationStructureTemplateId", "ParentDEPDepartmentTemplateId");

                    b.HasIndex("ParentDIVOrganizationStructureTemplateId", "ParentDIVDivisionTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivision", b =>
                {
                    ...
                    b.Property<int>("HeadOrganizationStructureTemplateDivisionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HeadOrganizationStructureTemplateDivisionId", "HeadPositionTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivisionCostCenter", b =>
                {
                    ...
                    b.HasKey("OrganizationStructureTemplateDivisionId", "CostCenterId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", b =>
                {
                    ...
                    b.HasIndex("OS_OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OS_OrganizationStructureTemplateDepartmentDepartmentTemplateId");

                    b.HasIndex("OS_OrganizationStructureTemplateDivisionOrganizationStructureTemplateId", "OS_OrganizationStructureTemplateDivisionDivisionTemplateId");
                    ...
                    b.HasIndex("ParentPositionOrganizationStructureTemplateId", "ParentPositionDepartmentTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateBusinessUnit", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateBusinessUnitPosition", "Head")
                        .WithMany()
                        .HasForeignKey("HeadOrganizationStructureTemplateBusinessUnitId", "HeadPositionTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartmentPosition", "Head")
                        .WithMany()
                        .HasForeignKey("HeadOrganizationStructureTemplateDepartmentId", "HeadPositionTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", "ParentDEP")
                        .WithMany()
                        .HasForeignKey("ParentDEPOrganizationStructureTemplateId", "ParentDEPDepartmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivision", "ParentDIV")
                        .WithMany()
                        .HasForeignKey("ParentDIVOrganizationStructureTemplateId", "ParentDIVDivisionTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivision", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivisionPosition", "Head")
                        .WithMany()
                        .HasForeignKey("HeadOrganizationStructureTemplateDivisionId", "HeadPositionTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", null)
                        ...
                        .HasForeignKey("OS_OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OS_OrganizationStructureTemplateDepartmentDepartmentTemplateId");
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivision", null)
                        ...
                        .HasForeignKey("OS_OrganizationStructureTemplateDivisionOrganizationStructureTemplateId", "OS_OrganizationStructureTemplateDivisionDivisionTemplateId");
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", "ParentPosition")
                        .WithMany()
                        .HasForeignKey("ParentPositionOrganizationStructureTemplateId", "ParentPositionDepartmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
