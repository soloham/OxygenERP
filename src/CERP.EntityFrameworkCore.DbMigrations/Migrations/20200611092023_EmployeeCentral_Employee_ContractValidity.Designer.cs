...
namespace CERP.Migrations
{
    ...
    [Migration("20200611092023_EmployeeCentral_Employee_ContractValidity")]
    partial class EmployeeCentral_Employee_ContractValidity
    {
            ...
            modelBuilder.Entity("CERP.HR.EmployeeCentral.Employee.Employee", b =>
                {
                    ...
                    b.Property<Guid>("EmployemeGroupId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("EmployemeSubGroupId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("EmployementTypeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EmployemeGroupId");

                    b.HasIndex("EmployemeSubGroupId");
            ...
            modelBuilder.Entity("CERP.HR.EmployeeCentral.Employee.Employee", b =>
                {
                    ...
                    b.HasOne("CERP.App.DictionaryValue", "EmployemeGroup")
                        .WithMany()
                        .HasForeignKey("EmployemeGroupId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CERP.App.DictionaryValue", "EmployemeSubGroup")
                        .WithMany()
                        .HasForeignKey("EmployemeSubGroupId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CERP.App.DictionaryValue", "EmployementType")
                        .WithMany()
