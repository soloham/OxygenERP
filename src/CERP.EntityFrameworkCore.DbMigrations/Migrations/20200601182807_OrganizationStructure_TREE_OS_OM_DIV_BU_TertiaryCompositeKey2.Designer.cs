...
namespace CERP.Migrations
{
    ...
    [Migration("20200601182807_OrganizationStructure_TREE_OS_OM_DIV_BU_TertiaryCompositeKey2")]
    partial class OrganizationStructure_TREE_OS_OM_DIV_BU_TertiaryCompositeKey2
    {
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateBusinessUnitCostCenter", b =>
                {
                    ...
                    b.HasKey("OrganizationStructureTemplateBusinessUnitId", "CostCenterId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", b =>
                {
                    ...
                    b.HasKey("OrganizationStructureTemplateId", "BusinessUnitTemplateId", "DepartmentTemplateId");

                    b.HasIndex("DepartmentTemplateId");

                    b.HasIndex("ParentBUOrganizationStructureTemplateId", "ParentBUBusinessUnitTemplateId");

                    b.HasIndex("ParentDEPOrganizationStructureTemplateId", "ParentDEPBusinessUnitTemplateId", "ParentDEPDepartmentTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartmentCostCenter", b =>
                {
                    ...
                    b.Property<int>("OrganizationStructureTemplateDepartmentBusinessUnitTemplateId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("OrganizationStructureTemplateDepartmentId", "CostCenterId");

                    b.HasIndex("CostCenterId");

                    b.HasIndex("OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OrganizationStructureTemplateDepartmentBusinessUnitTemplateId", "OrganizationStructureTemplateDepartmentDepartmentTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivision", b =>
                {
                    ...
                    b.Property<int>("ParentBusinessUnitTemplateId")
                        .HasColumnType("int");

                    b.Property<int>("ParentId")
                        .HasColumnType("int");

                    b.Property<int>("ParentOrganizationStructureTemplateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentOrganizationStructureTemplateId", "ParentBusinessUnitTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", b =>
                {
                    ...
                    b.HasIndex("OS_OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OS_OrganizationStructureTemplateDepartmentBusinessUnitTemplateId", "OS_OrganizationStructureTemplateDepartmentDepartmentTemplateId");
                    ...
                    b.HasIndex("ParentPositionOrganizationStructureTemplateId", "ParentPositionBusinessUnitTemplateId", "ParentPositionDepartmentTemplateId");
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", "ParentDEP")
                        .WithMany()
                        .HasForeignKey("ParentDEPOrganizationStructureTemplateId", "ParentDEPBusinessUnitTemplateId", "ParentDEPDepartmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartmentCostCenter", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", "OrganizationStructureTemplateDepartment")
                        ...
                        .HasForeignKey("OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OrganizationStructureTemplateDepartmentBusinessUnitTemplateId", "OrganizationStructureTemplateDepartmentDepartmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDivision", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateBusinessUnit", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentOrganizationStructureTemplateId", "ParentBusinessUnitTemplateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplatePosition", b =>
                {
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", null)
                        ...
                        .HasForeignKey("OS_OrganizationStructureTemplateDepartmentOrganizationStructureTemplateId", "OS_OrganizationStructureTemplateDepartmentBusinessUnitTemplateId", "OS_OrganizationStructureTemplateDepartmentDepartmentTemplateId");
                    ...
                    b.HasOne("CERP.HR.OrganizationalManagement.OrganizationStructure.OS_OrganizationStructureTemplateDepartment", "ParentPosition")
                        .WithMany()
                        .HasForeignKey("ParentPositionOrganizationStructureTemplateId", "ParentPositionBusinessUnitTemplateId", "ParentPositionDepartmentTemplateId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
